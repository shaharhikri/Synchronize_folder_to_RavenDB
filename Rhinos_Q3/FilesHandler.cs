...
namespace Rhinos_Q3
{
    public class FilesHandler
    {
        ...
        private string _last_run_date_path; //Cache file for last execution date.
        private string _last_run_ids_path;  //Cache file for last run files ids.
        private static readonly string FILE_TYPE = "json";

        private List<string> _modified_files_names; //names of jsons(files) that were modified AFTER last run.
        private List<string> _deleted_ids;          //id's of jsons(files) that were deleted AFTER last run.
        ...
        public FilesHandler(string files_folder_path, string last_run_date_path, string last_run_ids_path)
        {
            ...
            //Print _deleted_ids and _modified_files_names after init
            /*
        ...
        /*Updates Cache files ("last_run_date.txt", "last_run_ids.txt") for the next run after sync folder.*/
